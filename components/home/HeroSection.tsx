  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden gradient-hero">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-1/2 -left-40 w-[400px] h-[400px] rounded-full bg-accent/10 blur-3xl animate-float"
          style={{ animationDelay: "-3s" }}
        />
        <div
          className="absolute bottom-0 right-1/4 w-[300px] h-[300px] rounded-full bg-primary/5 blur-2xl animate-float"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-foreground">
              Free financial planning tools & guides
            </span>
          </motion.div>
          ...
          >
            Get practical money tips, easy-to-use{" "}
            <strong className="text-foreground">monthly budget calculators</strong>, and{" "}
            <strong className="text-foreground">after-tax salary tools</strong> designed to help you
            take control of your finances — 100% free and no signup required.
          </motion.p>
