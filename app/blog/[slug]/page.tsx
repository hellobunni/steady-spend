...
export default async function BlogPostPage({ params }: Props) {
  ...
  const articleSchema = {
    ...
    headline: post.title,
    description: post.description,
    image: post.featuredImage ? [post.featuredImage] : [`${baseUrl}/logo-vertical.png`],
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          {post.featuredImage && (
            <div className="mb-10 sm:mb-12">
              ...
              {post.imageCredit && (
                <p className="mt-3 text-xs text-slate-500">Image credit: {post.imageCredit}</p>
              )}
            </div>
          )}
                      ...
                      return (
                        <div className="logo-image-wrapper">
                          <Image
                            ...
                            unoptimized={
                              props.src.includes("cloudinary.com") ||
                              props.src.includes("clearbit.com")
                            }
                          />
                        </div>
                      );
