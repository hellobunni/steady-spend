...
import { Calculator, ChevronDown, ChevronUp, RotateCcw, Shield, TrendingDown } from "lucide-react";
...
export default function TakeHomePayCalculator() {
  ...
  const updateInput = <K extends keyof TakeHomePayInputs>(key: K, value: TakeHomePayInputs[K]) => {
  ...
  const handleNumberInput = (key: keyof TakeHomePayInputs, value: string) => {
          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="flex items-center gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) => updateInput("includeMedicare", checked === true)}
              />
              <label
                htmlFor="medicare"
                className="flex items-center gap-2 text-sm text-gray-700 cursor-pointer"
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => updateInput("hasLocalTax", checked === true)}
                    />
                    <label
                      htmlFor="local-tax"
                      className="flex items-center gap-2 text-sm text-gray-700 cursor-pointer"
        ...
        {showResults && results && results.annualGross > 0 && (
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Your Take-Home Pay</h2>
              <div className="h-px flex-1 bg-gray-200" />
            </div>
            ...
            <div className="flex justify-center gap-2">
              <Button
                ...
                className={viewMode === "annual" ? "bg-emerald-600 hover:bg-emerald-700" : ""}
              >
                Annual
              </Button>
              <Button
                ...
                className={viewMode === "paycheck" ? "bg-emerald-600 hover:bg-emerald-700" : ""}
              >
                Per Paycheck
              </Button>
            </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {inputs.includeMedicare && (
                      <div className="flex justify-between py-2">
                        ...
                        <span className="text-red-600">
                          -$
                          {(results.medicare + results.additionalMedicare).toLocaleString("en-US", {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          })}
                        </span>
                    ...
                    {results.stateTax > 0 && (
                      <div className="flex justify-between py-2">
                        <span className="text-gray-600">State Tax ({inputs.state})</span>
                        <span className="text-red-600">
                          -$
                          ...
                          {(() => {
                            const annual =
                              inputs.payPeriod === "yearly"
                                ? parseFloat(inputs.additionalWithholding) || 0
                                : inputs.payPeriod === "monthly"
                                  ? (parseFloat(inputs.additionalWithholding) || 0) * 12
                                  : (parseFloat(inputs.additionalWithholding) || 0) * 26;
