    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
        ...
        <section>
          ...
          <p className="leading-relaxed mb-4">
            Our budgeting tools use your browser&apos;s localStorage to save your input data locally
            on your device. This allows you to return to your calculations later without losing your
            work. This data:
          </p>
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li>Stays on your device and is never sent to our servers</li>
            <li>
              Can be cleared at any time through your browser settings or by using the reset
        ...
        <section>
          ...
          <p className="leading-relaxed mb-4">
            ...
            technologies to collect information about your browsing behavior to show you relevant
            ads.
          </p>
          <p className="leading-relaxed mb-4">
